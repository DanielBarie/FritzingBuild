...
```
This specifies libgit2 before `/opt/Qt6.6.1/lib/libQt6BundledPcre2.a`. Can't be... Fix order of linking. Can be seen in the Makefile, there's a ton of Qt PRIs, then there are the fritzing PRIs, then Qt PRI's...
